...
<section class="vp-shop-section">
    <div class="container th-container">
        <div class="vp-shop-panel vp-doc vp-legal">
            ...
            <p>
                اطلاعات کارت بانکی شما در این سایت وارد نمی‌شود. عملیات پرداخت
                تنها روی صفحهٔ درگاه بانکی انجام می‌گیرد و آنچه از هر تراکنش نزد
                ویکی پلاس ثبت می‌شود، شمارهٔ پیگیری تراکنش و چهار رقم پایانی کارت
                است که درگاه بانکی اعلام می‌کند. این اطلاعات صرفاً برای پیگیری
                تراکنش‌های ناموفق نگهداری می‌شود.
            </p>

            <h2>کوکی‌ها</h2>
            <p>
                این سایت از یک کوکی برای نگهداری وضعیت سبد خرید و ورود شما در
                مرورگرتان استفاده می‌کند؛ بدون آن، محتوای سبد خرید با جابه‌جایی
                میان صفحات از دست می‌رود. هیچ کوکی تبلیغاتی یا ردیابی روی این
                سایت قرار داده نمی‌شود.
            </p>
