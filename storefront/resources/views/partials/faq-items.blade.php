...
@endphp
        ...
        <details>
            ...
            <p>
                ...
                نمی‌خواهد، و ما هیچ‌کدام را نمی‌بینیم و ذخیره نمی‌کنیم.
            </p>
            </div>
        </details>
        ...
        <details>
            ...
            <div class="vp-faq-a">
            <p>
                بله، اما <strong>تنها برای تعویض سایز</strong>؛ مرجوعی به
                دلایل دیگر پذیرفته نمی‌شود. تا
                {{ fa_number($exchangeDays) }} روز بعد از تحویل با ما تماس
                بگیرید. کالا باید نپوشیده، بدون آسیب و همراه جعبه و متعلقاتش
                باشد، و هزینهٔ ارسال مرجوعی بر عهدهٔ خودتان است. هماهنگی فعلاً
                تلفنی انجام می‌شود، نه از داخل سایت.
            </p>
            <p>
